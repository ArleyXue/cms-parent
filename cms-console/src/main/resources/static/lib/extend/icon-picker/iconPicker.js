...
layui.define(['laypage', 'form'], function (exports) {
    ...
    IconPicker.prototype.render = function(options){
        var opts = options,
            ...
            // 默认图标
            defaultIcon = opts.defaultIcon == null ? "" : opts.defaultIcon,
            // 唯一标识
        ...
        var a = {
                    ...
                    '<div class="'+ TITLE +'" id="'+ TITLE_ID +'">' +
                        '<div class="layui-iconpicker-item">'+
                            '<span class="layui-iconpicker-icon layui-unselect">' +
                                '<i class="' + fontFamily + ' ' + defaultIcon + '"></i>' +
                            '</span>'+
            ...
            createList: function (text) {
                ...
                if (page){
                    ...
                    for (var i = 0; i < l; i++) {
                        ...
                        if (isFontClass){
                            m.append('<i class="' + fontFamily + ' '+ obj +'"></i>');
                        } else {
            ...
            check: function () {
                ...
                a.event('click', item, function (e) {
                    var el = $(e.currentTarget).find('.' + fontFamily),
                        icon = '';
                    if (isFontClass) {
                        var clsArr = el.attr('class').split(/[\s\n]/),
                            cls = clsArr[1],
                            icon = cls;
                        $('#' + TITLE_ID).find('.layui-iconpicker-item .' + fontFamily).html('').attr('class', clsArr.join(' '));
                    } else {
                        var cls = el.html(),
                            icon = cls;
                        $('#' + TITLE_ID).find('.layui-iconpicker-item .' + fontFamily).html(icon);
                    }

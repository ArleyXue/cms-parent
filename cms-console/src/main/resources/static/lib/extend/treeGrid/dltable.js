...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function(exports){
    ...
    Class.prototype.treeIconRender=function (o,isHtml) {
        ...
        var temTreeHtml='';
        if(iconOpen){
            var iconOpen='';//o[table.config.cols.iconOpen]?'style="background:url('+o[table.config.cols.iconOpen]+') 0 0 no-repeat;"':'';//自定义打开图标
